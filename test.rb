...
tour_end = Chronic::parse('2 hours from now')
...
# Find events at these venues
events = Event::get_events(venues, bounds, tour_start, tour_end)
puts "Found #{events.length} nearby events"
